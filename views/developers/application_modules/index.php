...
<script>
    ...
    $(function() {
        dataTable = $('#data-table').DataTable({
            ...
            columns: [
                {data: 'module', name: 'modules.module'},
                {data: 'module_description', name: 'modules.description'},
    ...
    function view(id) {
        $.ajax({
            ...
            success: function(response) {
                bootbox.dialog({
                    title: '{{view}} {{application_modules}}',
                    message: response
                });
            }
        });
    ...
    function create() {
        $.ajax({
            ...
            success: function(response) {
                bootbox.dialog({
                    title: '{{create}} {{application_modules}}',
                    message: response
                });
            }
        });
    ...
    function edit(id) {
        $.ajax({
            ...
            success: function(response) {
                bootbox.dialog({
                    title: '{{edit}} {{application_modules}}',
                    message: response
                });
            }
        });
