...
<div class="m-t-15">
    <ul class="nav nav-pills" role="tablist">
        <li class="active"><a href="#detail_paket" role="tab" data-toggle="tab">{{detail_produk}}</a></li>
                    ...
                    <?php if ($this->form->data('produk_detail')) { ?>
                        <?php foreach ($this->form->data('produk_detail') as $key => $produk_detail) { ?>
                            <tr data-row-id="<?= $produk_detail['id_produk_detail'] ?>">
                                ...
                                <td class="text-center"><?= $produk_detail['jumlah'] ?></td>
        ...
        <div role="tabpanel" class="tab-pane" id="pengaturan_harga">
            <!--<div class="form-group">
                ...
                <div class="input-group">
                    <?/*= $this->form->number('ppn_persen', $this->config->item('default_ppn'), 'id="ppn_persen" class="form-control" data-input-type="number-format"', "") */?>
